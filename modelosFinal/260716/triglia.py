...
def cargarDicHabitantes():
    archHab = open("habitantes.csv","r") # abrir archivo
    ...
    print("Dic hab: ",dicHab)                        # retornar el diccionario con los datos del archivo
...
def cargarListaHabitantes():
    ...
    archHab.close()                      # cerrar archivo
    print("Lista hab: ",listaHab)                     # retornar la lista cargada con los datos del archivo


def cargarDicLocalidades():
    archLoc = open("localidades.csv","r")# abrir archivo
    ...
    print("Dic loc: ",dicLoc)                       # retornar la lista con los datos del archivo

def cargarDicHabXLoc():
    archHabXLoc = open("habitantesXlocalidad.csv","r")# abrir archivo
    ...
    print("Dic habXloc: ",dicHabXLoc)                    # retornar la lista con los datos del archivo
...
def cantHabitantes(loc,hijos):
    ...
    listaCumple=[]                           # lista de los que cumplen la condición buscada en esta funcion
...
def main():
    ...
    cargarDicHabitantes() ; cargarListaHabitantes() ; cargarDicLocalidades() ; cargarDicHabXLoc()
