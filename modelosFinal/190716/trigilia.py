...
def cargarListavendedores():
    archVen = open("vendedores.csv","r")# abrir archivo
...
def cargarListaVentasTarjetas():
    archVenTar = open("ventasTarjetas.csv","r")# abrir archivo
...
def cargarListaComisiones():
    archComi = open("liquidacionComisiones.csv","r")#abrir archivo
...
def liquidar():
    ...
    archLiqComi = open("liquidacionComisiones.csv","w")  # abrir archivo
